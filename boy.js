// بيانات البطاقات - برومبتات الإنستجرام فقط
        const boysCardsData = [
            {
                id: 1,
                title: "رجل على سيارة تصميم كلاسيك",
                 category: "بنين", 
                image: "boy1.jpg",
                description: "حول صورتك إلى صورة أنيقة بتصميم كلاسيكي ",
            ...
            {
                id: 2,
                title: "رجل بنظرات خلفية سادة",
                category: "بنين", 
                image: "boy2.jpg",
                description: "حول صورتك إلى صورة أنيقة بتصميم عصرى ",
                prompt: "A hyper realistic Portrait of uploaded person preserve face 100% wearing high- end fashion OUTFIT, the background is orange, the clothing is minimal, hyper realistic scene, the guy is just slightly visible due to dark shadows, and he is wearing modern fashion frames.",
                stats: {  uses: 952 },
                badge: "شخصية",
                searchDescription: "نظرات سادة",
                 hashtags: ["", "", "", "", " وجه كامل", "شاب", ""]
            },


             {
                id: 3,
                title: "رجل بنظرات خلفية قطار",
                category: "بنين", 
                image: "boy3.jpg",
                description: "حول صورتك إلى صورة أنيقة بتصميم كلاسيكي ",
                prompt: "A hyperrealistic cinematic photograph capturing a fleeting, intimate moment on a dimly lit underground subway platform. The central subject is a stunning young Asian man, body positioned at a slight slant angle - not fully in profile and not fully frontal - with his face turned slightly, giving a subtle intrigue. His face, hairstyle, and eyeglasses remain exactly the same as in the attached reference photo, with a direct, piercing gaze into the camera. He stands perfectly still, a serene figure amidst the chaos, dressed in an elegant long black coat. In stark contrast, a vibrant yellow train rushes past in the background, its speed rendered as a brilliant, dynamic streak of motion blur.",
                stats: {  uses: 1232 },
                badge: "شخصية",
                 searchDescription: "قطار قديم",
                 hashtags: ["", "", "", "كلاسيك", "", "شاب", ""]
            },
...

            {
                ...
                image: "boy4.jpg",
                description: "حول صورتك إلى صورة أنيقة بتصميم عصرى ",
                prompt: "A candid photo of a man surrounded by paparazzi, using the provided image as a face reference - the same features, the same hair, the same face. He is wearing an oversized black blazer over a black men's tank top, giving the look an elegant and luxurious vibe. The shot captures him in the middle of the paparazzi crowd, with cameras and photographers visible in the foreground to enhance the candid effect. Daylight falls from the side, creating a dramatic red-carpet atmosphere. Multiple camera flashes go off around him, adding a sense of glamour, world-class celebrity, and full public attention.",
                stats: {  uses: 1442 },
                badge: "شخصية",
                 searchDescription: " مشهور",
                 hashtags: ["", "", "", "", "عصرى", "شاب", ""]
            ...
            
            {
                ...
                stats: {  uses: 1226 },
                badge: "شخصية",
                 searchDescription: " عميق ",
                 hashtags: ["", "", "", "عصرى", "عميق", "شاب", ""]
...

              {
                ...
                image: "boy6.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "A cinematic portrait of me standing by a wooden doorway, leaning slightly against the frame in a relaxed pose. My body is angled to the side, while my head is turned outward as I gaze into the distance with a calm, confident, and thoughtful expression. Both of my hands are positioned at my waistline, one hand adjusting the cuff of my white dress shirt in a subtle, elegant gesture. I am wearing a tailored black suit jacket with structured shoulders, paired with a crisp white shirt with the top button undone, giving a refined yet relaxed look. A loosely knotted black tie hangs naturally, complementing the formal outfit. The fabric of the suit is matte and sharply cut, emphasizing sophistication and elegance. Behind me, the background is dark and shadowy, with warm, subtle light adding depth and creating a cinematic contrast. The shot is captured at eye-level with a portrait focal length around 85mm, producing a shallow depth of field that keeps me in sharp focus while softly blurring the background. The directional lighting casts gentle shadows across my face and suit, enhancing textures and giving the scene a moody, stylish, and cinematic atmosphere.",
                stats: {  uses: 3055 },
                badge: "شخصية",
                 searchDescription: "  بدلة",
                 hashtags: ["", "", "", "", "عصرى", "شاب", ""]
            ...
            
             {
                ...
                image: "boy8.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "A monochrome portrait of me sitting in a relaxed pose against a plain background. My body is angled slightly forward, with my right arm bent upward so that my hand rests casually on my forehead, fingers framing the side of my face in a natural gesture. My left arm rests lower, close to my body. I am looking directly at the camera with a calm but slightly intense expression, lips slightly parted, giving the image a moody and introspective feeling. I am wearing a loose-fitting white T-shirt, slightly wrinkled, with small distressed details visible on the fabric near the chest area. The shirt drapes naturally across my torso and shoulders. I am also wearing dark denim jeans, with one knee bent upward and partly visible in the frame. The shot is taken at eye-level, using a portrait focal length around 85mm, which creates a shallow depth of field and keeps the background softly blurred. The black-and-white tones emphasize contrast, shadows, and textures, highlighting the casual outfit, the relaxed but expressive pose, and the overall moody, editorial style of the image.",
                stats: {  uses: 211 },
                badge: "شخصية",
                 searchDescription: "  عميق ",
...

          {
                ...
                stats: {  uses: 65102 },
                badge: "شخصية",
                 searchDescription: " غابة",
                 hashtags: ["", "", "", "عميق", "بورتريه", "شاب", ""]
...

             {
                ...
                image: "boy10.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "A full-body portrait of me standing outdoors on a rooftop terrace with a blurred city skyline in the background. I am standing slightly sideways in the frame, with my body turned at a subtle angle, while keeping my legs apart in a confident stance. Both of my hands are casually resting inside the side pockets of my bomber jacket. I am wearing a light beige bomber jacket with a subtle sheen, slightly oversized, layered over a white hoodie with the hood resting loosely on my back. Underneath, the hoodie's front pocket is visible. I am also wearing relaxed-fit, light grey jogger sweatpants with elastic cuffs at the ankles. On my feet are clean white sneakers with chunky soles. My head is facing forward, and I am looking directly toward the camera with a calm, confident expression. My hair is styled in a natural, tousled way. The camera captures me from a low angle shot, making me appear taller and more dominant in the frame. The perspective is enhanced with a portrait lens around 50mm, creating a natural look with shallow depth of field that softly blurs the background. The lighting is soft and diffused, evoking a calm, urban, streetwear atmosphere.",
                stats: {  uses: 84222 },
                badge: "شخصية",
                 searchDescription: " هودى شتاء",
                 hashtags: ["", "", "", "هودى", "عصرى", "شاب", ""]
            ...
            
              {
                ...
                stats: {  uses: 78222 },
                badge: "شخصية",
                 searchDescription: " شاشات قديمة ",
                 hashtags: ["", "", "عميق", "قديم", "كلاسيك", "شاب", ""]
...

            {
                ...
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " هاتف ",
                 hashtags: ["", "", "مختلف", "عصرى", "هاتف", "شاب", ""]
...

            {
...

             {
                ...
                image: "boy31.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "Ultra-realistic full-body fashion portrait of a young man sitting on a modern chair or step, one hand resting on his knee and the other casually relaxed. He has medium-length voluminous wavy black hair styled neatly, a trimmed beard, and a calm, confident expression. He is wearing an all-black casual athleisure outfit: relaxed-fit black sweatshirt, black jogger pants. and stylish black-and-white mixed sneakers. His beautiful girlfriend is standing beside him or slightly behind, stylishly dressed in a fashionable outfit, with trendy sunglasses covering her face, giving a chic and confident look. Both are positioned naturally, capturing a relaxed and cozy urban fashion vibe. The background is a large, modern, minimalistic setting with a giant abstract white and black number 'A' design, cinematic 4K quality, soft natural lighting",
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " بورتريه   ",
                 hashtags: ["", "", "", "عميق", "طبيعة", "شاب", ""]
...

               {
                ...
                image: "boy32.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "Ultra-realistic, cinematic 4K full-body fashion portrait of a young man with a medium build body and his girlfriend walking side by side, holding hands naturally. Their steps are synchronized. with one foot stepping forward mid-motion. He looks confidently toward the camera, while she gazes ahead. His outfit: all-black athleisure (relaxed sweatshirt, jogger pants, sneakers). Her outfit: chic fitted modern fashion with matching shoes. Background: luxury car parked stylishly, modern minimalistic setting with giant abstract diamond shape, soft natural lighting for a high-fashion editorial feel.",
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " بورتريه   ",
                 hashtags: ["", "", "", "عميق", "طبيعة", "شاب", ""]
...

            {
                ...
                image: "boy33.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "of the user naturally lounging or reclining (one arm under or behind head) on giant 3D letters spelling PUBG don't change my look Hyper-realistic cinematic artwork",
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " بورتريه   ",
                 hashtags: ["", "", "", "عميق", "طبيعة", "شاب", ""]
...

             {
                ...
                image: "boy34.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "Crie uma imagem hiper-realista em angulo extremamente baixo, cinematográfico, mostrando uma pessoa sentada no banco do motorista de um carro vintage preto em chamas. O fogo consome violentamente o capô e o teto, enquanto a porta do motorista está aberta e uma das pernas da pessoa está para fora, com o pé apoiado no asfalto. Ela se inclina levemente para frente e olha para a câmera com uma expressão confiante e serena. O cabelo é de comprimento médio, limpo e bem cuidado, levemente arrepiado pelo vento. A pessoa veste uma camiseta oversized de basquete, tênis robustos e meias listradas coloridas que aparecem discretamente. O rosto esta em foco nítido, iluminado dramaticamente pelo reflexo das chamas, criando fortes contrastes de luz e sombra. O ambiente transmite tensão e intensidade, com o contraste entre o laranja ardente do fogo e a escuridão profunda ao redor. Fumaça e labaredas se elevam ao fundo, reforcando a atmosfera cinematográfica de um editorial de ação. Use a imagem fornecid",
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " بورتريه   ",
                 hashtags: ["", "", "", "عميق", "طبيعة", "شاب", ""]
...

            {
                ...
                image: "boy35.jpg",
                description: "حول صورتك إلى صورة جذابة بتصميم عصرى ",
                prompt: "use 100% face above uploaded photo A stark, theatrical portrait focusing on a charismatic male subject, illuminated by a single, powerful spotlight, creating a sense of isolation and dramatic intensity. Subject: A handsome South Asian man in his late 20s to early 30s, with dark hair and a confident, relaxed demeanor. He is seated centrally on a vintage, low-slung dark red or maroon sofa. He is dressed in smart casual attire: an open dark brown or olive shirt over a plain cream or off-white t. shirt, light-colored (beige/cream) trousers, and brown suede loafers with no socks. His posture is relaxed yet commanding, with one leg crossed over the other, forearms resting on his knees. His gaze is direct and engaging, looking towards the camera, Setting: The setting is entirely black and minimalist, emphasizing the subject. The sofa is the only visible prop, centered within the frame, There are no distracting elements in the background, ensuring all focus is on the man and his illuminated sp",
                stats: {  uses: 95855 },
                badge: "شخصية",
                 searchDescription: " بورتريه   ",
                 hashtags: ["", "", "", "عميق", "طبيعة", "شاب", ""]
